/*
 ...
 Source Schema         : nongcai

 Target Server Type    : MySQL
 Target Server Version : 80037 (8.0.37)
 File Encoding         : 65001

 Date: 26/11/2024 16:07:36
*/
...
CREATE TABLE `forum`  (
  `forumID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `forumTitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `forumContent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `forumUsername` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `forumTime` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `forumType` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `forumAmount` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `forumImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
...
CREATE TABLE `forumreply`  (
  ...
  `replyTime` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `replyImg` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `replyForumID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `replyName` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `message`  (
  `messageID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageVideoID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageUserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageUserName` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageContent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageTime` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `messageImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `user`  (
  ...
  `password` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `userImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `userAddress` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userPhone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `userQQ` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userEmail` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userCollection` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userState` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `userLoginTime` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `userIP` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('004bcfc8d4bd407bb1a114785539006f', 'admin', '男', '123321aaa', '/static/userHand_Top/upload/gaoxiao.gif', '四川省遂宁市船山区河沙镇中国村中国舌中国区26号', '17583108191', '794799102', '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('038f34ae31dc409bbdb05b737cec26e8', 'admin7947991022', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '13778731502', NULL, '123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('04d416043f084a918bbebd4d0ca45175', 'test4', '女', '123321aaa', '/static/userHand_Top/upload/MyHand.png', '浙江省温州市', '17583108191', '12391238', '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('09e710b61e4448c893688d38adb3afbb', 'shefeng313131', NULL, 'shefeng1321232313213', '/static/userHand_Top/upload/MyHand.png', NULL, '17583108131', NULL, '123123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('214b2c014b9047678c911d91625e8be2', 'test5', '空', '123321aaa', '/static/userHand_Top/upload/MyHand.png', '妈卖批的地址', '17583108191', '空', '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('24027b34fe42448cb1a63d268fb95b99', 'sf3123123123', NULL, 'sf3123123123', '/static/userHand_Top/upload/MyHand.png', NULL, '17583108131', NULL, '123123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('2a100f4c5d284a93ac979ff1abc0447d', 'test7', '空', 'test7', '/static/userHand_Top/upload/MyHand.png', '广东省东莞市', '17583108191', '空', '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('375f1f8007e84f94be2d7790c8bc4764', 'test2', '空', '123321aaa', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', '空', '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('4391f2bd436a4cbea7bca8b9a63a11cd', 'admin794719911021', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '17583108191', NULL, '123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('43aa8df18aa64c88a0205628085317ac', 'admin794799102', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '13778731502', NULL, '7947123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('43ea2f8048d344eabf0551fc153d952b', 'test10', NULL, 'test10', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('48627d2e0cac4733adf25ae29a795222', 'test8', NULL, 'test8', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('4edc207b60ef4f57afedbccdf632cac2', 'admin2121212', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '13778731502', NULL, '7917923123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('6d77df52e480400b9e753f701884668c', 'admin794799102123', NULL, '123321aaa1', '/static/userHand_Top/upload/MyHand.png', NULL, '17583108191', NULL, '7947123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('8432cde1f35b4f09a21bd9b2231b6897', 'admin2', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '', NULL, '', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('8d9aa7e33d6c495bb8753641c4cd9a2d', 'test9', '男', 'test9', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', '', '异常', NULL, NULL);
INSERT INTO `user` VALUES ('9ce782924532475b9112e50e6915dab2', 'sf1222112', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '17583108191', NULL, '123321@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('a4b6727effce4eefb04f455a7b04cd6a', 'test11', NULL, 'test11', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('aaae08476f5042d4a4045505cbd8e419', 'test6', '女', '123321aaa', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', NULL, '异常', NULL, NULL);
INSERT INTO `user` VALUES ('af7c4dea15c142c8aad31098c244f198', 'test12', NULL, 'test12', '/static/userHand_Top/upload/MyHand.png', '四川省遂宁市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('b4cf395ef4484fcfa7a1fbced7078cc7', 'test3', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', '广东省东莞市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('c56a56e6c92e43098454059b91b716f7', 'username1', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', '广东省东莞市', '17583108191', NULL, '276709588@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('c83aecd87c3846ef8d05e884541a7ced', 'admin794799102212', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '13778731502', NULL, '7917923123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('cd22d74ca41b4f01a14e9c7101db4cb6', 'baopi123', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', '广东省东莞市', '17583108191', NULL, '344970928@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('e560a6b2177748b0a3ec8b064c42e1cf', 'admin7947991021', NULL, '123321aaa', '/static/userHand_Top/upload/MyHand.png', NULL, '13778731502', NULL, '123@qq.com', NULL, '正常', NULL, NULL);
INSERT INTO `user` VALUES ('fcb5cbdcebd546fea7264bbf6cb9d5fe', 'test13', NULL, 'test13', '/static/userHand_Top/upload/MyHand.png', '广东省东莞市', '17583108191', NULL, '794799102@qq.com', NULL, '正常', NULL, NULL);
...
CREATE TABLE `video`  (
  `videoID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `videoName` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `videoImage` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `videoAddress` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `videoDuration` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `videoCollection` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `videoComment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `videoUploadTime` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `videoState` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `videoType` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
